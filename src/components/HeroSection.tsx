    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="fade-in-up">
          ...
          <div className="relative inline-block mx-auto mb-6 [&_svg]:outline [&_svg]:outline-4 [&_svg]:outline-white [&_svg]:outline-offset-0">
  <Heart className="w-12 h-12 text-wedding-blush pulse-heart" />
</div>
